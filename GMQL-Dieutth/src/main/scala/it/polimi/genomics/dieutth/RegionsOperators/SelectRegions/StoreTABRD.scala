...
import it.polimi.genomics.dieutth.loaders.writeMultiOutputFiles
import it.polimi.genomics.dieutth.loaders.writeMultiOutputFiles.RDDMultipleTextOutputFormat
...
object StoreTABRD {
  ...
  def apply(executor: GMQLSparkDieuExecutor, path: String, value: RegionOperator, associatedMeta:MetaOperator, schema : List[(String, PARSING_TYPE)], coordinateSystem: GMQLSchemaCoordinateSystem.Value, sc: SparkContext): RDD[GRECORD] = {
