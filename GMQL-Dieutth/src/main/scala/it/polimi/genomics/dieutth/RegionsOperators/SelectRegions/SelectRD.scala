...
object SelectRD {
  ...
  def apply(executor: GMQLSparkDieuExecutor, regionCondition: Option[RegionCondition], filteredMeta: Option[MetaOperator], inputDataset: RegionOperator, sc: SparkContext): RDD[GRECORD] = {
