package it.polimi.genomics.dieutth.MetaOperators
...
object GroupMD {
  ...
  def apply(executor: GMQLSparkDieuExecutor, groupingKeys : MetaGroupByCondition, aggregates : Option[List[MetaAggregateFunction]], newGroupNameInMeta : String, inputDataset : MetaOperator, regionDataset : RegionOperator, sc: SparkContext): RDD[MetaType] = {
    ...
    import it.polimi.genomics.dieutth.MetaOperators.GroupOperator.MetaGroupMGD._
