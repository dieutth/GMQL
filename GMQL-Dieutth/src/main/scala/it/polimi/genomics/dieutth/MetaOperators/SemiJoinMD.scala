...
object SemiJoinMD {
  ...
  def apply(executor : GMQLSparkDieuExecutor, externalMeta : MetaOperator, joinCondition : MetaJoinCondition, inputDataset : MetaOperator, sc : SparkContext) : RDD[MetaType] = {
