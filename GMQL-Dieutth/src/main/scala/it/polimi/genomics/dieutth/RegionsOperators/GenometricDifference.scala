...
object GenometricDifference {
  ...
  def apply(executor: GMQLSparkDieuExecutor, grouping: OptionalMetaJoinOperator, leftDataset: RegionOperator, rightDataset: RegionOperator, exact:Boolean, sc: SparkContext): RDD[GRECORD] = {
