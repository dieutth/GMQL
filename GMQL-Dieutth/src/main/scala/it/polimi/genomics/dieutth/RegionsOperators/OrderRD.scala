...
object OrderRD {
  ...
  def apply(executor : GMQLSparkDieuExecutor, ordering : List[(Int, Direction)], topParameter : TopParameter, inputDataset : RegionOperator, sc : SparkContext) : RDD[GRECORD] = {
