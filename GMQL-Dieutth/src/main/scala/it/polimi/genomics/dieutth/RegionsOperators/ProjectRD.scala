...
object ProjectRD {
  ...
  def apply(executor : GMQLSparkDieuExecutor, projectedValues : Option[List[Int]], tupleAggregator : Option[List[RegionExtension]], inputDataset : RegionOperator, inputMeta: MetaOperator, env : SparkContext) : RDD[GRECORD] = {
