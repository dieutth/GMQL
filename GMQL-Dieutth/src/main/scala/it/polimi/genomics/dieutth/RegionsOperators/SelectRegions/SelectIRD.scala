...
import it.polimi.genomics.dieutth.loaders.Loaders._
...
object SelectIRD {
  ...
  var executor: GMQLSparkDieuExecutor = null

  @throws[SelectFormatException]
  def apply(executor: GMQLSparkDieuExecutor, regionCondition: Option[RegionCondition], filteredMeta: Option[MetaOperator], loader: GMQLLoader[Any, Any, Any, Any], URIs: List[String], repo: Option[String], sc: SparkContext): RDD[GRECORD] = {
